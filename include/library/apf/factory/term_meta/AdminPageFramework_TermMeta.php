...
abstract class TaskScheduler_AdminPageFramework_TermMeta_Router extends TaskScheduler_AdminPageFramework_TaxonomyField_Controller {
}
abstract class TaskScheduler_AdminPageFramework_TermMeta_Model extends TaskScheduler_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new TaskScheduler_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class TaskScheduler_AdminPageFramework_TermMeta_View extends TaskScheduler_AdminPageFramework_TermMeta_Model {
...
abstract class TaskScheduler_AdminPageFramework_TermMeta_Controller extends TaskScheduler_AdminPageFramework_TermMeta_View {
}
abstract class TaskScheduler_AdminPageFramework_TermMeta extends TaskScheduler_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'task-scheduler') {
