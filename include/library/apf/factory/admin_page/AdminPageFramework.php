...
abstract class TaskScheduler_AdminPageFramework_Model_Form extends TaskScheduler_AdminPageFramework_Router {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'task-scheduler') {
        ...
        new TaskScheduler_AdminPageFramework_Model__FormEmailHandler($this);
...
abstract class TaskScheduler_AdminPageFramework_Controller extends TaskScheduler_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new TaskScheduler_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, '_isInThePage'),));
    }
...
abstract class TaskScheduler_AdminPageFramework extends TaskScheduler_AdminPageFramework_Controller {
    ...
    private function _getCallerPath($sCallerPath) {
        ...
        $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? TaskScheduler_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
