...
abstract class TaskScheduler_AdminPageFramework_Utility_String extends TaskScheduler_AdminPageFramework_Utility_VariableType {
    ...
    static public function minifyCSS($sCSSRules) {
        trigger_error(TaskScheduler_AdminPageFramework_Registry::NAME . ': ' . sprintf('The method, %1$s, is deprecated. Use %2$s instead.', 'minifyCSS()', 'getCSSMinified()'), E_USER_NOTICE);
...
class TaskScheduler_AdminPageFramework_Utility extends TaskScheduler_AdminPageFramework_Utility_HTMLAttribute {
