...
class TaskScheduler_AdminPageFramework_Form_Model___SetFieldResources extends TaskScheduler_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new TaskScheduler_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('TaskScheduler_AdminPageFramework_Form_View___CSS_Form', 'TaskScheduler_AdminPageFramework_Form_View___CSS_Field', 'TaskScheduler_AdminPageFramework_Form_View___CSS_Section', 'TaskScheduler_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'TaskScheduler_AdminPageFramework_Form_View___CSS_FieldError', 'TaskScheduler_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('TaskScheduler_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
