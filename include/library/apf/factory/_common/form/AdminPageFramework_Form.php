...
class TaskScheduler_AdminPageFramework_Form_Model extends TaskScheduler_AdminPageFramework_Form_Base {
    ...
    public function dropRepeatableElements(array $aSubject) {
        $_oFilterRepeatableElements = new TaskScheduler_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
    ...
    public function _replyToRegisterFormItems() {
        ...
        $_oFieldResources = new TaskScheduler_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
...
class TaskScheduler_AdminPageFramework_Form_View extends TaskScheduler_AdminPageFramework_Form_Model {
    ...
    public function get() {
        ...
        new TaskScheduler_AdminPageFramework_Form_View___Script_Form;
        $_oFormTables = new TaskScheduler_AdminPageFramework_Form_View___Sectionsets(array('capability' => $this->sCapability,) + $this->aArguments, array('field_type_definitions' => $this->aFieldTypeDefinitions, 'sectionsets' => $this->aSectionsets, 'fieldsets' => $this->aFieldsets,), $this->aSavedData, $this->getFieldErrors(), $this->aCallbacks, $this->oMsg);
...
class TaskScheduler_AdminPageFramework_Form extends TaskScheduler_AdminPageFramework_Form_Controller {
    ...
    public $sCapability = '';
    public $aCallbacks = array('capability' => null, 'is_in_the_page' => null, 'is_fieldset_registration_allowed' => null, 'load_fieldset_resource' => null, 'saved_data' => null, 'fieldset_output' => null, 'section_head_output' => null, 'sectionset_before_output' => null, 'fieldset_before_output' => null, 'is_sectionset_visible' => null, 'is_fieldset_visible' => null, 'secitonsets_before_registration' => null, 'fieldsets_before_registration' => null, 'fieldset_after_formatting' => null, 'fieldsets_before_formatting' => null, 'handle_form_data' => null,);
    public $oMsg;
    ...
    public function __construct() {
        ...
        $this->oSubmitNotice = new TaskScheduler_AdminPageFramework_Form___SubmitNotice;
        $this->oFieldError = new TaskScheduler_AdminPageFramework_Form___FieldError($this->aArguments['caller_id']);
        $this->oLastInputs = new TaskScheduler_AdminPageFramework_Form_Model___LastInput($this->aArguments['caller_id']);
        parent::__construct();
        $this->construct();
    }
