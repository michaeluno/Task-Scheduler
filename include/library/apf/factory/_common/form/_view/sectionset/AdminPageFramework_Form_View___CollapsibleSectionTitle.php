...
class TaskScheduler_AdminPageFramework_Form_View___Section_Base extends TaskScheduler_AdminPageFramework_Form_Base {
    ...
    class TaskScheduler_AdminPageFramework_Form_View___SectionTitle extends TaskScheduler_AdminPageFramework_Form_View___Section_Base {
        ...
        private function _getDebugInfo($aSectionset) {
            ...
            $_oToolTip = new TaskScheduler_AdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('section_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => TaskScheduler_AdminPageFramework_Debug::getDetails($aSectionset) . '<span class="task-scheduler-info">' . $this->getFrameworkNameVersion() . '  (' . $this->oMsg->get('debug_info_will_be_disabled') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aSectionset['_section_path'] . '_debug');
            return $_oToolTip->get();
        }
    ...
    class TaskScheduler_AdminPageFramework_Form_View___CollapsibleSectionTitle extends TaskScheduler_AdminPageFramework_Form_View___SectionTitle {
        ...
        protected function _getCollapsibleSectionsEnablerScript() {
            ...
            self::$_bLoaded = true;
            new TaskScheduler_AdminPageFramework_Form_View___Script_CollapsibleSection($this->oMsg);
        }
    }
