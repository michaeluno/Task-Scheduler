...
class TaskScheduler_AdminPageFramework_Form_View___Sectionsets extends TaskScheduler_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        $_oDebugInfo = new TaskScheduler_AdminPageFramework_Form_View___DebugInfo($this->aArguments['structure_type'], $this->oMsg);
        $_sOutput = implode(PHP_EOL, $_aOutput);
        $_sElementID = "task-scheduler-sectionsets-" . uniqid();
        return $this->_getSpinnerOutput($_sOutput) . "<div id='{$_sElementID}' class='task-scheduler-sctionsets task-scheduler-form-js-on'>" . $_sOutput . TaskScheduler_AdminPageFramework_Form_View___Script_SectionTab::getEnabler() . $_oDebugInfo->get() . "</div>";
    }
    ...
    private function _getSubSections($_aOutputs, $_sSectionsID, $_aSection, $_aSubSections) {
        if (!empty($_aSection['repeatable'])) {
            $_aOutputs['section_contents'][] = TaskScheduler_AdminPageFramework_Form_View___Script_RepeatableSection::getEnabler($_sSectionsID, $_aOutputs['count_subsections'], $_aSection['repeatable'], $this->oMsg);
            $_aOutputs['section_contents'][] = $this->_getRepeatableSectionFlagTag($_aSection);
        }
        if (!empty($_aSection['sortable'])) {
            $_aOutputs['section_contents'][] = TaskScheduler_AdminPageFramework_Form_View___Script_SortableSection::getEnabler($_sSectionsID, $_aSection['sortable'], $this->oMsg);
