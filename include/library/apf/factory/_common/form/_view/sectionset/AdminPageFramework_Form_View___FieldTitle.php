...
class TaskScheduler_AdminPageFramework_Form_View___FieldTitle extends TaskScheduler_AdminPageFramework_Form_Utility {
    ...
    private function _getDebugInfo($aField) {
        ...
        $_oToolTip = new TaskScheduler_AdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('field_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => TaskScheduler_AdminPageFramework_Debug::get($aField) . '<span class="task-scheduler-info">' . $this->getFrameworkNameVersion() . '  (' . __('This information will be disabled when <code>WP_DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'task-scheduler') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aField['field_id'] . '_debug');
        return $_oToolTip->get();
    }
