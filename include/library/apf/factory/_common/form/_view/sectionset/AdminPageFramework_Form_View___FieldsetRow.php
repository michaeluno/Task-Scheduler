...
class TaskScheduler_AdminPageFramework_Form_View___FieldsetTableRow extends TaskScheduler_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getFieldTitle(array $aField) {
        ...
        return "<label class='task-scheduler-field-title' for='" . $_oInputTagIDGenerator->get() . "'>" . "<a id='{$aField['field_id']}'></a>" . "<span title='" . esc_attr(strip_tags(is_array($aField['description']) ? implode('&#10;', $aField['description']) : $aField['description'])) . "'>" . $aField['title'] . $this->_getTitleColon($aField) . $this->_getToolTip($aField['tip'], $aField['field_id']) . "</span>" . "</label>";
    }
