...
class TaskScheduler_AdminPageFramework_Form_View___Script_SectionTab extends TaskScheduler_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.task-scheduler-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='task-scheduler-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
