...
( function( $ ) {
    ...
    $.fn.addTaskScheduler_AdminPageFrameworkRepeatableSection = function( sSectionContainerID ) {
        ...
        var _incrementAttributes = function( oElement, iSectionsCount, oSectionsContainer ) {
            ...
            $( oElement ).find( 'tr.task-scheduler-fieldrow, .task-scheduler-fieldset, .task-scheduler-fields, .task-scheduler-field, table.form-table, input,textarea,select' )
                .incrementAttribute( 
                    'id', 
                    iSectionsCount,
                    _sSectionIDModel
