...
class TaskScheduler_AdminPageFramework_Form_View___Script_RepeatableField extends TaskScheduler_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    $.fn.updateTaskScheduler_AdminPageFrameworkRepeatableFields = function( aSettings ) {
        ...
        if ( ! $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions ) {
            $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions = [];
        }
        if ( ! $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions.hasOwnProperty( _sFieldsContainerID ) ) {     
            $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ] = $.extend({    
        ...
        var _aOptions = $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ];
...
// @todo For nested fields, the `find()` method should be avoided.
        $( nodeThis ).find( '.task-scheduler-repeatable-field-buttons' ).attr( 'data-max', _aOptions[ 'max' ] );
        $( nodeThis ).find( '.task-scheduler-repeatable-field-buttons' ).attr( 'data-min', _aOptions[ 'min' ] );
        $( nodeThis ).find( '.task-scheduler-repeatable-field-buttons' ).attr( 'data-fadein', _aOptions[ 'fadein' ] );
        $( nodeThis ).find( '.task-scheduler-repeatable-field-buttons' ).attr( 'data-fadeout', _aOptions[ 'fadeout' ] );
...
// @todo For nested fields, the `find()` method should be avoided.        
        ...
        var _sFieldID           = nodeThis.find( '.repeatable-field-add-button' ).first().closest( '.task-scheduler-field' ).attr( 'id' );
        var _nCurrentFieldCount = jQuery( '#' + _sFieldsContainerID ).find( '.task-scheduler-field' ).length;
    ...
    $.fn.addTaskScheduler_AdminPageFrameworkRepeatableField = function( sFieldContainerID ) {
        ...
        if ( 'undefined' === typeof sFieldContainerID ) {
            var sFieldContainerID = $( this ).closest( '.task-scheduler-field' ).attr( 'id' );
        }
        ...
        if ( ! $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions.hasOwnProperty( _sFieldsContainerID ) ) {     
            var nodeButtonContainer = nodeFieldContainer.find( '.task-scheduler-repeatable-field-buttons' );
            $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ] = {    
        ...
        var _iFadein  = $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'fadein' ];
        var _iFadeout = $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'fadeout' ];

        // Show a warning message if the user tries to add more fields than the number of allowed fields.
        var sMaxNumberOfFields = $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ]['max'];
        if ( sMaxNumberOfFields != 0 && nodeFieldsContainer.find( '.task-scheduler-field' ).length >= sMaxNumberOfFields ) {
            var nodeLastRepeaterButtons = nodeFieldContainer.find( '.task-scheduler-repeatable-field-buttons' ).last();
        ...
        // For nested fields,
/*         $( nodeNewField ).find( '.task-scheduler-field' ).each( function( iIterationIndex ) {    
...
// console.log( oElement.find( 'fieldset.task-scheduler-fieldset' ).length );
// console.log( oElement.find( 'fieldset.task-scheduler-fieldset' ).first().attr( 'id' ) );
            // oElement.find( 'fieldset.task-scheduler-fieldset' ).incrementAttributes(
...
// console.log( oElement.find( 'fieldset.task-scheduler-fieldset' ).first().attr( 'id' ) );
    ...
    $.fn.removeTaskScheduler_AdminPageFrameworkRepeatableField = function() {
        ...
        var sMinNumberOfFields  = $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'min' ];
        if ( sMinNumberOfFields != 0 && nodeFieldsContainer.find( '.task-scheduler-field' ).length <= sMinNumberOfFields ) {
            var nodeLastRepeaterButtons = nodeFieldContainer.find( '.task-scheduler-repeatable-field-buttons' ).last();
            ...
            var _iFadeout = $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'fadeout' ]
                ? $.fn.aTaskScheduler_AdminPageFrameworkRepeatableFieldsOptions[ _sFieldsContainerID ][ 'fadeout' ]
                : 500;
            nodeMessage.delay( 2000 ).fadeOut( _iFadeout );
            return;     
        }     
