...
( function( $ ) {
    ...
    $.fn.initializeTaskScheduler_AdminPageFrameworkCollapsibleSections = function() {
        ...
        jQuery( this ).find( '.task-scheduler-collapsible-sections-title, .task-scheduler-collapsible-section-title' )
    ...
    $.fn.enableTaskScheduler_AdminPageFrameworkCollapsibleButton = function() {
        ...
        function _isFieldElement( nodeTarget ) {
            ...
            if ( jQuery( nodeTarget ).hasClass( 'task-scheduler-collapsible-button' ) ) {
                return false;
            }
