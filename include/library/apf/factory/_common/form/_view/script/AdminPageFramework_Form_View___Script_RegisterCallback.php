...
(function ( $ ) {
     ...
     */  
    $( document ).bind( 'task-scheduler_added_repeatable_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){          
     ...
     */
    $( document ).bind( 'task-scheduler_repeated_field', function( oEvent, iCallType, oModelContainer ){
