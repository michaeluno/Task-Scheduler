...
class TaskScheduler_AdminPageFramework_Form_View___ToolTip extends TaskScheduler_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return '' . "<a href='{$_sHref}' class='task-scheduler-form-tooltip'>" . $this->_getTipLinkIcon() . "<span class='task-scheduler-form-tooltip-content'>" . $this->_getTipTitle() . $this->_getDescriptions() . "</a>";
    }
    ...
    private function _getTipTitle() {
        if (isset($this->aArguments['title'])) {
            return "<span class='task-scheduler-form-tool-tip-title'>" . $this->aArguments['title'] . "</span>";
        }
        return '';
    }
    private function _getDescriptions() {
        if (isset($this->aArguments['content'])) {
            return "<span class='task-scheduler-form-tool-tip-description'>" . implode("</span><span class='task-scheduler-form-tool-tip-description'>", $this->getAsArray($this->aArguments['content'])) . "</span>";
        }
        return '';
    }
}
