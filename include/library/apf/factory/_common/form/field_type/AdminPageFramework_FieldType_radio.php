...
class TaskScheduler_AdminPageFramework_FieldType_radio extends TaskScheduler_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".task-scheduler-field input[type='radio'] {margin-right: 0.5em;} .task-scheduler-field-radio .task-scheduler-input-label-container {padding-right: 1em;} .task-scheduler-field-radio .task-scheduler-input-container {display: inline;} .task-scheduler-field-radio .task-scheduler-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.task-scheduler-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).prop( 'checked', false );
