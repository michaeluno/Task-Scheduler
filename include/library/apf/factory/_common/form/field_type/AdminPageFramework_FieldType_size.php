...
class TaskScheduler_AdminPageFramework_FieldType_size extends TaskScheduler_AdminPageFramework_FieldType_select {
    ...
    protected function getStyles() {
        return ".task-scheduler-field-size input {text-align: right;}.task-scheduler-field-size select.size-field-select {vertical-align: 0px; }.task-scheduler-field-size label {width: auto; } .form-table td fieldset .task-scheduler-field-size label {display: inline;}";
    }
    protected function getField($aField) {
