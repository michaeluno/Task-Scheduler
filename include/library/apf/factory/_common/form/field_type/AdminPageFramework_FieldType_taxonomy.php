...
class TaskScheduler_AdminPageFramework_FieldType_taxonomy extends TaskScheduler_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new TaskScheduler_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
...
jQuery( document ).ready( function() {
    ...
    jQuery().registerTaskScheduler_AdminPageFrameworkCallbacks( {     
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            // Repeatable Sections
            if ( 1 === iCallType ) {
                var _oSectionsContainer     = jQuery( oCloned ).closest( '.task-scheduler-sections' );
            ...
            // Repeatable fields 
                ...
                var _oFieldsContainer       = jQuery( oCloned ).closest( '.task-scheduler-fields' );
            ...
            enableTaskScheduler_AdminPageFrameworkTabbedBox( jQuery( oCloned ).find( '.tab-box-container' ) );            
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".task-scheduler-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.task-scheduler-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.task-scheduler-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.task-scheduler-field .taxonomy-checklist ul ul {margin-left: 1em;}.task-scheduler-field .taxonomy-checklist-label {white-space: nowrap; }.task-scheduler-field .tab-box-container.categorydiv {max-height: none;}.task-scheduler-field .tab-box-tab-text {display: inline-block;}.task-scheduler-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.task-scheduler-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 2px;background-color: #fff;}.task-scheduler-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.task-scheduler-field .tab-box-tabs li a { color: #333; text-decoration: none; }.task-scheduler-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.task-scheduler-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.task-scheduler-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.task-scheduler-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.task-scheduler-field .tab-box-content:target, .task-scheduler-field .tab-box-content:target, .task-scheduler-field .tab-box-content:target { display: block; }.task-scheduler-field .tab-box-content .select_all_button_container, .task-scheduler-field .tab-box-content .select_none_button_container{margin-top: 0.8em;}.task-scheduler-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
