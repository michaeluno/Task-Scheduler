...
class TaskScheduler_AdminPageFramework_FieldType_import extends TaskScheduler_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".task-scheduler-field-import input {margin-right: 0.5em;}.task-scheduler-field-import label,.form-table td fieldset.task-scheduler-fieldset .task-scheduler-field-import label { display: inline; }";
    }
